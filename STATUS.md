...
- [x] **batch_download_complete 事件模板调查**（2026-06-28）— 不存在，download_batch 无通知调用，需传 notification_mgr 参数，详见 [docs/batch_download_event_status.md](docs/batch_download_event_status.md)
