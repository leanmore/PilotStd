...
- [x] **validity_checker 现有规则全览**（2026-06-28）— 6个配置项中2个仅前端展示（frequency/execute_time），1个硬编码无效（update_interval），无APScheduler调度，详见 [docs/validity_checker_current_state.md](docs/validity_checker_current_state.md)
