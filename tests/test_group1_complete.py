...
class TestModelsComplete(unittest.TestCase):
    def test_parsed_std_info_all_fields(self):
        ...
        info = ParsedStdInfo(
            raw_filename="test.pdf", logical_code="GB/T", number=1, year=2020, std_name="Test",
            part=1, ext=".pdf", language="zh", file_kind="standard",
...
class TestFileMoverComplete(unittest.TestCase):
    ...
    def test_normalize_filename(self):
        ...
        from pilotstd.models import ParsedStdInfo
        fm = FileMover(self.db)
        info = ParsedStdInfo(raw_filename="test.pdf", logical_code="GB/T", number=1, year=2020, std_name="Test", ext=".pdf")
    ...
    def test_move_to_expire(self):
        ...
        with open(src, "w") as f:
            f.write("test")
        fm = FileMover(self.db)
        info = ParsedStdInfo(raw_filename="test.pdf", logical_code="GB/T", number=1, year=2000, std_name="Old", ext=".pdf")
