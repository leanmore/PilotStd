...
@pytest.mark.parametrize("code, expected", [
    # GB 类
    ("GB", "gb"), ("GB/T", "gb"), ("GB/Z", "gb"), ("GSB", "gb"),
    # 国际标准
    ("ISO", "iso_iec"), ("IEC", "iso_iec"),
    # 国外标准
    ("API", "foreign"), ("ASME", "foreign"), ("ASTM", "foreign"),
    ("BS", "foreign"), ("DIN", "foreign"), ("EN", "foreign"),
    ("ANSI", "foreign"), ("MSS", "foreign"), ("UL", "foreign"),
    ("ITU", "foreign"), ("AWWA", "foreign"),
    # 地方标准
    ("DB22", "db"), ("DB22/T", "db"), ("DB65/T", "db"),
    # 团体标准
    ("TCCSAS", "group"), ("TZZB", "group"), ("TCED", "group"),
    # 企业标准
    ("SG", "enterprise"),
    # 行业标准
    ("SH/T", "industry"), ("NB/T", "industry"), ("HG/T", "industry"),
    ("JB/T", "industry"), ("NBSHT", "industry"), ("JBZQ", "industry"),
    ("SHS", "industry"), ("SHJ", "industry"),
    # 未知
    ("UNKNOWN_CODE_XYZ", ""),
])
