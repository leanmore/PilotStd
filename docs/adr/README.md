...
| 编号 | 文件 | 标题 | 日期 | 状态 |
|------|------|------|------|:--:|
| 001 | [ADR-001](ADR-001-modal-dialog-auto-clicker.md) | 模态对话框自动点击器 | 2026-07-14 | ✅ |
| 002 | [ADR-002](ADR-002-handler-governance.md) | Handler 层混合策略治理 | 2026-07-16 | ✅ |
| 003 | [ADR-003](ADR-003-persistence-pattern.md) | 纯逻辑提取范式（Engine-Handler 分离） | 2026-07-16 | ✅ |
