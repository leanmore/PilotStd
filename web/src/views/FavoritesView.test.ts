...
// 组件在 main.ts 里是全局注册的（SFC 不 import），测试需自行注册用到的这些
const GLOBAL_COMPONENTS = { Button, Column, DataTable, Tag, TabPanel, TabView }

// 本文件每个用例都要挂载一次完整收藏页（DataTable + TabView），jsdom 下首次挂载
