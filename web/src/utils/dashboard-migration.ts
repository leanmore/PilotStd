...
export function createDefaultLayout(): DashboardLayoutV1 {
  return {
    ...
    widgets: [
      ...
      {
        id: 'adapter-announce',
        type: 'adapter-announce',
        layout: { i: 'adapter-announce', x: 0, y: 2, w: 6, h: 3, minW: 3, minH: 3 },
        config: { title: '公告适配器', refreshInterval: 30 },
      },
      {
        id: 'adapter-query',
        type: 'adapter-query',
        layout: { i: 'adapter-query', x: 6, y: 2, w: 6, h: 3, minW: 3, minH: 3 },
        config: { title: '查询适配器', refreshInterval: 30 },
      },
      {
        id: 'announcements',
        type: 'recent-announce',
        layout: { i: 'announcements', x: 0, y: 5, w: 12, h: 4, minW: 3, minH: 3 },
