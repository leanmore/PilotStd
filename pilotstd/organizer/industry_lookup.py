...
INDUSTRY_MAP: dict[str, str] = {
    ...
    "SY": "石油天然气", "TB": "铁路运输", "TD": "土地管理", "TY": "体育",
    "WB": "物资管理", "WH": "文化", "WJ": "兵工民品", "WM": "外经贸",
    "WS": "卫生", "WW": "文物保护", "XB": "稀土", "XF": "消防救援",
    "YB": "黑色冶金", "YC": "烟草", "YD": "通信",
    "YJ": "减灾救灾与综合性应急管理",
    "YS": "有色金属", "YY": "医药", "YZ": "邮政", "ZY": "中医药",
    # 补充行业标准（附录一未列但实际存在）
    "JGJ": "建筑工程", "JJF": "国家计量技术规范", "JJG": "国家计量检定规程",
    "TSG": "特种设备安全技术规范", "SHS": "石油化工设备维护检修规程",
    "JBZQ": "机械部重型机械企业标准",  # 已作废，改为 JB/T
    "NBSHT": "能源行业石油化工标准",  # NB/SH/T 组合前缀
    "HT": "化工/环保行业标准",  # 历史代号，现多转为行业标准
    "TCCSAS": "中国化学品安全协会团体标准",  # T/CCSAS
    "TZZB": "浙江制造团体标准",  # T/ZZB
    "TCED": "化工行业技术指导性文件",  # 化工设备图样技术要求
    ...
    "CAC": "国际食品法典委员会", "WHO": "世界卫生组织",
    # 主要发达国家标准
    "ANSI": "美国国家标准学会", "ASME": "美国机械工程师学会",
    "ASTM": "美国材料与试验协会", "API": "美国石油学会",
    "UL": "美国保险商实验室", "MIL": "美国军用标准",
    "DIN": "德国标准化学会", "BS": "英国标准",
    "JIS": "日本工业标准", "GOST": "俄罗斯国家标准",
    # 区域性标准及其他
    "EN": "欧洲标准", "CSA": "加拿大标准协会", "NF": "法国标准",
    "MSS": "美国阀门及管件工业协会", "AWWA": "美国水工协会",
}
...
FOREIGN_CODES = {"ISO", "IEC", "ITU", "CAC", "WHO",
                 "ANSI", "ASME", "ASTM", "API", "UL", "MIL",
                 "DIN", "BS", "JIS", "GOST", "EN", "CSA", "NF", "MSS", "AWWA"}
