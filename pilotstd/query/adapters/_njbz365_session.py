...
# njbz365 会话管理与请求签名 — 从 njbz365.py 提取
...
class _Njbz365SessionMixin:
    """njbz365 会话管理、CSRF 刷新、请求签名与重试逻辑（混入 Njbz365Adapter）。"""
